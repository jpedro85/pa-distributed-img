...
/**
 * Represents an interfaceEvent of {@link InterfaceEvents} with a single name associated with it.
...
public class InterfaceEventWithName implements InterfaceEvent{
     ...
     *   @param name       A String that identifies the client images to notify .(e.g. the path)
     */
